    ...
    <section className="Services-Home">
      <div className="container h-100">
        <div className="row h-100">
          {/* start left section */}
          <div className="left-side col-md-6 col-12 d-flex flex-nowrap align-items-end">
          ...
          {/* start right section */}
          <div className="right-side col-md-6 col-12 d-flex flex-column justify-content-evenly align-items-start my-auto">
